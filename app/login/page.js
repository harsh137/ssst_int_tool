                ...
                <div className="hidden lg:block anim-fade-up">
                    <div className="clay-card-lg p-8" style={{ background: 'linear-gradient(145deg, #1A1F36 0%, #252B45 100%)', border: '1px solid rgba(255,255,255,0.10)' }}>
                        ...
                        <div className="space-y-3">
                            {[
                                { icon: '💰', en: 'Donation & Receipt Management', hi: 'दान एवं रसीद प्रबंधन' },
                                { icon: '📊', en: 'Expense Tracker & Approvals', hi: 'व्यय ट्रैकर एवं अनुमोदन' },
                                { icon: '🔐', en: 'Role-Based Access Control', hi: 'भूमिका-आधारित पहुँच नियंत्रण' },
                                { icon: '📄', en: 'CA & Tally Report Export', hi: 'CA एवं Tally रिपोर्ट निर्यात' },
                            ].map((f, i) => (
